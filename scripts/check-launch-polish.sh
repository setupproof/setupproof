...
assert_contains "$README" "Verify marked README quickstarts in a clean temporary workspace."
assert_contains "$README" "SetupProof is for maintainers who want setup instructions to fail in CI before"
assert_contains "$README" "## Try It Locally"
assert_contains "$README" "Package-manager installs, public external"
assert_contains "$README" "packaged installs are not out yet"
assert_contains "$README" "go run ./cmd/setupproof review README.md"
assert_contains "$README" "go run ./cmd/setupproof init"
...
assert_contains "$SUPPORT" "SetupProof v0.1 runs from this source tree."
